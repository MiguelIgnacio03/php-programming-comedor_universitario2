    ...
    <div class="dashboard">
        ...
        <main class="main-content">
            ...
            <div class="card">
                ...
                <form action="<?php echo URLROOT; ?>/categorias/crear" method="POST">
                    <div class="form-grid">
                        <div class="form-group">
                            <label for="nombre">Nombre de la Categoría</label>
                            <input type="text" id="nombre" name="nombre" required placeholder="Ej: Lacteos, Carnes..." pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" title="Solo se permiten letras y espacios">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex; gap: 20px; align-items: center; margin-top: 10px;">
                                <label style="display: flex; align-items: center; gap: 5px; cursor: pointer;">
                                    <input type="checkbox" name="perecedero" id="perecedero" checked onclick="toggleDias(this)">
                                    Es Perecedero
                                </label>
                            </div>
                        </div>

                        <div class="form-group" id="dias-container">
                            <label for="dias_caducidad">Días de Caducidad Estimados</label>
                            <input type="number" id="dias_caducidad" name="dias_caducidad" placeholder="Ej: 7" min="1">
                            <small>Para cálculo automático de vencimiento (opcional)</small>
                        </div>
