    ...
    <div class="dashboard">
        ...
        <main class="main-content">
            ...
            <div class="card" style="max-width: 600px; margin: 0 auto;">
                ...
                <form action="<?php echo URLROOT; ?>/proveedores/crear" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 1rem;">Guardar Proveedor</button>
                </form>
            </div>
        </main>
    </div>
